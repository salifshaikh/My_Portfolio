...
export default function RedoTextAnimation({ delay }: IRedoTextAnimationProps) {
  ...
  const texts = [
    "I am a proficient Frontend Developer!",
    ...
    "Exploring the backend tech these days....",
    ...
    "We're running low in time? I got it letss goooo",
  ];
  ...
  return (
    <motion.span className="h-32 max-w-96 bg-sky-500 text-[1.2rem] font-bold dark:bg-blue-950 md:text-[1.5rem] lg:text-[1.7rem]">
      {displayText}
    </motion.span>
  );
}
